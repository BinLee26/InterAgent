...
# 加载原始 YAML 文件
yaml_path = 'ase/data/motions/intergen_amp/dataset_intergen_amp.yaml'  # 替换为你的 YAML 文件路径
...
# 保存到新的 YAML 文件
output_path = 'ase/data/motions/intergen_amp_datasets/dataset_intergen_amp_sample3.yaml'
