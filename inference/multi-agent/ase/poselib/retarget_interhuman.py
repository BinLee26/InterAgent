...
def retarget_motion(source_motion_path, target_motion_path):
    ...
    for p in ['person1','person2']:
        ...
        source_motion = SkeletonMotion.from_skeleton_state(smpl_skeleton_state, 59.94)
    ...
    # parse data from retarget config
        ...
        #second_min_h = torch.kthvalue(tar_global_pos[..., 2].view(-1), 2).values
        #print("2th min",tar_global_pos.shape)
...
def main():
    ...
    source_path = 'ase/data/motions/InterGen/motions/'
    #target_path = '../data/motions/interhuman_amp_split/'
    target_path = 'ase/data/motions/intergen_amp_height_fix/'
